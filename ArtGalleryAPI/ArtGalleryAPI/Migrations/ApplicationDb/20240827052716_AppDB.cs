        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppOrder_Address_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Address",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppOrder_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ProductCost = table.Column<decimal>(type: "decimal(13,3)", precision: 13, scale: 3, nullable: false),
                    TaxCost = table.Column<decimal>(type: "decimal(13,3)", precision: 13, scale: 3, nullable: false),
                    ShippingCost = table.Column<decimal>(type: "decimal(13,3)", precision: 13, scale: 3, nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_AppOrder_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppOrder_AddressId",
                table: "AppOrder",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOrder_AppUserId",
                table: "AppOrder",
                column: "AppUserId");
